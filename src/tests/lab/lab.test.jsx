...
describe("Status component", () => {
  ...
  test('should switch to "🟢 Online" when button is clicked once', () => { });
...
describe("HeroesFromAPI component", () => {
  ...
  test("should render a list of heroes after successful API fetch", () => { });

  test.skip("BONUS: should display an error message when API request fails with status 500", () => { });
});
